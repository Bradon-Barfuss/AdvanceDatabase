...
-------------------------------
IF EXISTS (SELECT * FROM sysobjects WHERE id = OBJECT_ID(N'[dbo].udf_getOrderDate'))
...
SELECT dbo.udf_getProductID('Weber State University Coaches Hat');
SELECT dbo.udf_getProductID('Weber State University Putter Cover');
SELECT dbo.udf_getProductID('Weber State University Rain Poncho');
SELECT dbo.udf_getProductID('Weber State University Volleyball Short Sleeve T-Shirt');
SELECT dbo.udf_getProductID('Black Weber State University Women''s Hooded Sweatshirt');

SELECT dbo.udf_getProductID('cover');
SELECT dbo.udf_getProductID('hi o');
SELECT dbo.udf_getProductID('cho');
SELECT dbo.udf_getProductID('T-Shirt');
SELECT dbo.udf_getProductID('sweatshirt');