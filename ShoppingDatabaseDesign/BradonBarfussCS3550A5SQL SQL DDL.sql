...
-----------------------------------
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Eagle Software Inc'), (SELECT sdProduct_id FROM Product where productName = 'Black Weber State University Women''s Hooded Sweatshirt'), '1', '48');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Art Crafters'), (SELECT sdProduct_id FROM Product where productName = 'Yellow Weber State University 16 oz. Tumbler'), '1', '42');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Burton & Davis'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Rain Poncho'), '1', '5.95');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Jets Cybernetics'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Alumni T-Shirt'), '1', '19.95');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Professionals Unlimited'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Volleyball Short Sleeve T-Shirt'), '1', '19.95');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Linguistic Systems Inc'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Wildcats State Decal'), '1', '6.95');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Price Business Services'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Putter Cover'), '1', '25');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Mitsumi Electronics Corp'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Crew Socks'), '1', '18');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Sidewinder Products Corp'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Short Sleeve T-Shirt'), '1', '30');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Circuit Solution Inc'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Boys'' Tri-Blend Short Sleeve T-Shirt'), '1', '15.99');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Eagle Software Inc'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Coaches Hat'), '1', '25');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Art Crafters'), (SELECT sdProduct_id FROM Product where productName = 'Black Weber State University Women''s Hooded Sweatshirt'), '1', '48');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Burton & Davis'), (SELECT sdProduct_id FROM Product where productName = 'Yellow Weber State University 16 oz. Tumbler'), '1', '42');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Jets Cybernetics'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Rain Poncho'), '1', '5.95');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Professionals Unlimited'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Alumni T-Shirt'), '1', '19.95');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Linguistic Systems Inc'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Volleyball Short Sleeve T-Shirt'), '1', '19.95');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Price Business Services'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Wildcats State Decal'), '1', '6.95');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Mitsumi Electronics Corp'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Putter Cover'), '1', '25');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Sidewinder Products Corp'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Crew Socks'), '1', '18');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Circuit Solution Inc'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Short Sleeve T-Shirt'), '1', '30');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Eagle Software Inc'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Boys'' Tri-Blend Short Sleeve T-Shirt'), '1', '15.99');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Art Crafters'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Coaches Hat'), '1', '25');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Burton & Davis'), (SELECT sdProduct_id FROM Product where productName = 'Black Weber State University Women''s Hooded Sweatshirt'), '1', '48');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Jets Cybernetics'), (SELECT sdProduct_id FROM Product where productName = 'Yellow Weber State University 16 oz. Tumbler'), '1', '42');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Professionals Unlimited'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Rain Poncho'), '1', '5.95');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Linguistic Systems Inc'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Alumni T-Shirt'), '1', '19.95');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Price Business Services'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Volleyball Short Sleeve T-Shirt'), '1', '19.95');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Mitsumi Electronics Corp'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Wildcats State Decal'), '1', '6.95');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Sidewinder Products Corp'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Putter Cover'), '1', '25');
INSERT INTO VendorProduct (sdVendor_id, sdProduct_id, quantityOnHand, vendorProductPrice) VALUES ( (SELECT sdVendor_id FROM vendor where vendorName = 'Circuit Solution Inc'), (SELECT sdProduct_id FROM Product where productName = 'Weber State University Crew Socks'), '1', '18');


-------------------------------
--- Insert OrderItems Table ---
-------------------------------
INSERT INTO OrderItem (sdOrderTable_id, sdProduct_id, sdVendor_id, quantity) VALUES ( (select sdOrderTable_id FROM OrderTable where sdCustomer_id =(Select sdCustomer_id from customer where customerEmailAddress = 'donette.foller@cox.net')AND orderDateTime = (Select convert (datetime, '02/14/2023  7:18:00 AM'))), (Select sdProduct_id from product where ProductName = 'Black Weber State University Women''s Hooded Sweatshirt'), (SELECT sdVendor_id FROM Vendor WHERE vendorName = 'Eagle Software Inc'), '1');
